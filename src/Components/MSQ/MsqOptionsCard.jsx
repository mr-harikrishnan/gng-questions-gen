...
function MsqOptionsCard({ formik, index, correctAnswer, setCorrectAnswer }) {
    ...
    const deleteOptions = (idx) => {
        ...
        // Adjust correctAnswer list after deletion
        ...
        <div>
            ...
            <div className='flex items-center gap-3'>
                ...
                <svg
                    ...
                    className={`${formik.values.options.length > 2 ? "block" : "hidden"} size-5 cursor-pointer hover:scale-120`}
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="red">
            ...
            <div className='flex gap-4 items-center'>
                ...
                <div
                    ...
                    className={`${correctAnswer.includes(index) ? "bg-[#71C9CE] justify-end" : "bg-gray-200 justify-start"} border flex items-center border-gray-100 h-7 rounded-3xl min-w-12 py-1`}>
